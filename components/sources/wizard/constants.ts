...
// LLM models are defined in mock-data settings (settings.llmModels)
...
export const SYSTEM_DATABASE_FIELDS: Record<string, SystemFieldConfig> = {
  ...
  sourceName: {
    dataType: "string",
    description: "Configured Source Name (acts as broker/marketplace label)",
    autoGenerated: true,
    example: "Emagine"
  },
  detailsLink: {
  ...
  llmTokensPrompt: {
    dataType: "number",
    description: "Tokens sent to the model (prompt/input)",
    autoGenerated: true,
    example: "800"
  },
  llmTokensCompletion: {
    dataType: "number",
    description: "Tokens received from the model (completion/output)",
    autoGenerated: true,
    example: "447"
  },
  llmTokensUsed: {
    dataType: "number",
    description: "DEPRECATED: total tokens for this extraction (use llmTokensPrompt + llmTokensCompletion)",
    autoGenerated: true,
    example: "1247"
  },
  llmCost: {
    dataType: "number (SEK)",
    description: "Actual cost in USD reported by provider (display may convert)",
    autoGenerated: true,
    example: "0.0523"
  },
